        ...
        <div>
            ...
            <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <a href="{{ route('lectures') }}"
                   class="inline-flex items-center justify-center rounded-xl border border-solid border-white/30 px-6 py-3 text-sm font-bold text-white transition hover:bg-white/10">
                    Lihat Data Dosen
                </a>
            </div>
...
<section class="bg-slate-50 py-20">
    <div class="mx-auto max-w-5xl rounded-3xl bg-gradient-to-br from-blue-700 to-blue-950 px-6 py-14 text-center text-white shadow-xl sm:px-10">
        ...
        <div class="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <a href="{{ route('news') }}" class="rounded-xl border border-solid border-white/30 px-6 py-3 text-sm font-bold text-white hover:bg-white/10">
                Baca Berita
            </a>
        </div>
    </div>
